[![downloads](https://img.shields.io/npm/dt/eslint-config-fp.svg?logo=npm)](https://www.npmjs.com/package/eslint-config-fp) [![last commit](https://img.shields.io/github/last-commit/autoquality/eslint-config-fp.svg?logo=github)](https://github.com/autoquality/eslint-config-fp/graphs/contributors) [![license](https://img.shields.io/github/license/autoquality/eslint-config-fp.svg?logo=github)](https://www.apache.org/licenses/LICENSE-2.0) [![npm](https://img.shields.io/npm/v/eslint-config-fp.svg?logo=npm)](https://www.npmjs.com/package/eslint-config-fp) [![node](https://img.shields.io/node/v/eslint-config-fp.svg?logo=node.js)](#) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg?logo=javascript)](https://standardjs.com) [![eslint-config-fp](https://img.shields.io/badge/eslint-config--fp-green.svg?logo=eslint)](https://github.com/autoquality/eslint-config-fp)
...
Then create a symlink to the Prettier configuration and `.editorconfig` in your
project:
...
The following badge can be added to your project: [![eslint-config-fp](https://img.shields.io/badge/eslint-config--fp-green.svg?logo=eslint)](https://github.com/autoquality/eslint-config-fp)
